...
const writing = [
  ...
  { title: 'Finding Wriggle Room: How I Made a Maggot Simulator', href: 'https://issuu.com/independenceamazing/docs/a_maze_magazin_nr_4_druck_01/16', text: 'Critical and creative considerations behind my thesis, Every Creeping Thing. Published by A MAZE Magazine.' },
  { title: 'Savage Beasts: Civilization and Wilderness in Skyrim', href: 'https://www.firstpersonscholar.com/', text: 'A look at the divisions between human civilization and hostile wilderness in Skyrim. Published by First Person Scholar.' },
  ...
  { title: 'Ladies’ Man: Womanizing in The Witcher', href: 'https://ontologicalgeek.com/ladies-man-womanizing-in-the-witcher/', text: 'A critical look at the mechanics of seduction and sex in The Witcher.' },
